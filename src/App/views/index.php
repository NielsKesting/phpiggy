        ...
        <tbody class="divide-y divide-gray-200 bg-white">
            <?php foreach ($transactions as $transaction) : ?>
                <tr>
                    ...
                    <!-- Amount -->
                    <td class="p-4 text-sm text-gray-600"><?php echo '€';
                                                            echo escape($transaction['amount']) ?></td>
                    <!-- Receipt List -->
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="-mt-px flex w-0 flex-1">
            <?php if ($currentPage > 1) : ?>
                <a href="/?<?php echo escape($prevousPageQuery); ?>" class="inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
